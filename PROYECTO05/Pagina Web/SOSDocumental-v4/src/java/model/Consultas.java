...
public class Consultas extends Conexion {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(co.busquedaDocumento("12345"));
    ...
    public boolean exixtenciaDocumento(String idDocumento) {
        PreparedStatement pst = null;
        ResultSet rs = null;

        try {
            String consulta = "Select * from Documento where idDocumento = ? || nomDocumento = ?";
            pst = getConexion().prepareStatement(consulta);
...
//-------------------------------------------------Listos-----------------------------------------------------
    public boolean consultaActualizacion(String idDocumento) {
        PreparedStatement pst = null;
        ResultSet rs = null;
        try {
            String consulta = "Select idDocumento, fechaVersion, idUsuario, documento, version from Actualizacion where idDocumento = ?;";
            ...
            if (rs.absolute(1)) {
                ...
                Date fecha = rs.getTimestamp("fechaVersion");
                int idUsuario = rs.getInt("idUsuario");
                Blob documento = rs.getBlob("documento");
                int version = rs.getInt("version");

                String fehaf = sumaHoras(fecha);

                int versionf = version + 1;
    ...
    public boolean registroActualizacion(String idDocumento, String fecha, int version, String idUsuario, InputStream documento) {
        PreparedStatement pst = null;
        try {
    ...
    public boolean actulizarActualizacion(String idDocumento, int version, String fecha, String idUsuario, InputStream documento) {
        PreparedStatement pst = null;
        try {
            String actualizacion = "update Actualizacion set fechaVersion = ?, idUsuario = ?, documento = ?, version = ? where idDocumento = ?;";
            pst = getConexion().prepareStatement(actualizacion);
     ...
     */
    public boolean registroDocumento(int idDocumento, String nomDocumento, String fechaRegistro, String idUsuario, InputStream documento, int version, String ext) {
    ...
    public boolean actualizarDocumento(String idDocumento, String fecha, String idUsuario, InputStream documento, int version) {
        PreparedStatement pst = null;
        try {
            String insercion = "update documento set fechaRegistro = ?, idUsuario = ?, documento = ?, version = ? where idDocumento = ?;";
            pst = getConexion().prepareStatement(insercion);
    ...
    public boolean registroReporteEspecifico(int idDocumento, String nomDocumento, String fechaRegistro, String idUsuario, int version) {
        ...
        try {
            ...
            System.out.println("Error: Reporte Especifico" + e);
        } finally {
            try {
                if (getConexion() != null) {
                    getConexion().close();
    ...
    public boolean registroReporteGlobal(int idDocumento, int descargas, int busquedas, String fecha, String idUsuario) {
        ...
        try {
            ...
            pst.setInt(1, 0);
            pst.setInt(2, idDocumento);
            pst.setInt(3, descargas);
            pst.setInt(4, busquedas);
            ...
            System.out.println("Error Reporte Global " + e);
        } finally {
            try {
                if (getConexion() != null) {
                    getConexion().close();
    ...
    public String sumaHoras(Date fecha) {
    ...
    public boolean BusquedaActualizacion(String idDocumento) {
        PreparedStatement pst = null;
        ResultSet rs = null;

        try {
            String consulta = "Select Documento.idDocumento, Documento.nomDocumento, actualizacion.fechaVersion, Actualizacion.version as'versionA', Actualizacion.documento, Actualizacion.tipoDocumento from Actualizacion inner join Documento on Documento.idDocumento = actualizacion.IdDocumento where Actualizacion.idDocumento = ? || Documento.nomDocumento = ?";
            ...
            if (rs.absolute(1)) {
                ...
                busquedaServlet.datosA.add(rs.getString("idDocumento"));
                busquedaServlet.datosA.add(rs.getString("nomDocumento"));

                busquedaServlet.datosA.add(sumaHoras(rs.getTimestamp("fechaVersion")));
                busquedaServlet.datosA.add(rs.getString("versionA"));

                descargarServlet.documentoA = rs.getBytes("documento");
                descargarServlet.idDocumento = rs.getString("idDocumento");
                descargarServlet.versionA = rs.getString("versionA");
                descargarServlet.extA = rs.getString("tipoDocumento");
    ...
    public boolean busquedaDocumento(String idDocumento) {
        PreparedStatement pst = null;
        ResultSet rs = null;

        try {
            String consulta2 = "Select Documento.idDocumento, Documento.nomDocumento, Documento.fechaRegistro, Documento.version, Documento.documento, Documento.tipoDocumento from Documento  where idDocumento = ? || nomDocumento = ?";
            ...
            if (rs.absolute(1)) {
                ...
                busquedaServlet.datos.add(rs.getString("idDocumento"));
                busquedaServlet.datos.add(rs.getString("nomDocumento"));

                busquedaServlet.datos.add(sumaHoras(rs.getTimestamp("fechaRegistro")));
                busquedaServlet.datos.add(rs.getString("version"));

                descargarServlet.documento = rs.getBytes("documento");
                descargarServlet.idDocumento = rs.getString("idDocumento");
                descargarServlet.version = rs.getString("version");
                descargarServlet.ext = rs.getString("tipoDocumento");
