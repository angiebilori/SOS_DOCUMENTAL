...
public class agregarPdfServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String nomDocumento = "prueba";
        String codigo = "1234561";
        String fechaRegistro = "1994/11/28 02:06:04";
        ...
        if(request.getPart("anexo").getSize()>0){
            ...
            if (filePart.getSize() > 0) {
                ...
                if(co.registrarPdf(1010110, codigo, nomDocumento, fechaRegistro, 1030647666, inputStream))
                {
                    out.print("<h1>Error:0 </>");
                }else{
