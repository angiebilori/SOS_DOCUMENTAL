    ...
    reader.onload = function (e) {
        ...
        for (var i = 0; i <= extVisibles.length; i++) {
            ...
            if (ext == extVisibles[i]) {
                document.getElementById("prev").style.height = "250px"; //Si el archivo es visible se visualiza el div contenedor
                 document.getElementById("frame").style.height = "250px";
